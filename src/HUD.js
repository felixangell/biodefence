export class HUD {
    ...
    update() {
        ...
        } else if (this.age > 10 && this.age <= 20){ // Ages 10-20 take 20 seconds each for a total of 200 seconds or 3.33 minutes.
            ageInterval = 20 * SECOND;       
        } else if (this.age > 20 && this.age <= 40){// Ages 20-40 take 15 seconds each for a total of 300 seconds or 5 minutes.
            ageInterval = 15 * SECOND;
        } else if (this.age > 40 && this.age <= 80){// Ages 40-80 take 10 seconds each for a total of 400 seconds or 6.66 minutes.
